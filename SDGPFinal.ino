...
char server[] = "dentacare.azurewebsites.net";

void send_request(String value,int AcX)
{
if (client.connect(server, 80)) {
Serial.println("Connection success");
client.print("GET /HTTPrequest.php?"); // This
client.print("gyroscope="); // This
client.print(value);
client.print("&accelerometer="); // This
client.print(AcX);
client.println(" HTTP/1.1"); // Part of the GET request
client.println("Host: dentacare.azurewebsites.net");
